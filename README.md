...
[![Version](https://img.shields.io/badge/version-v40.1-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-94_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-116_total-lightblue)](./scripts/)
...
| **Gobernanza** | 63 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 63 normas del catálogo tienen guard o audit.
...
Las 94 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 94 tools activas — 37 grupos
...
- 94 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
- 49 normas: 51 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
...
```
scripts/                    ← 116 archivos Python (94 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
