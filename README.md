...
[![Version](https://img.shields.io/badge/version-v40.12-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-101_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-124_total-lightblue)](./scripts/)
...
| **Gobernanza** | 68 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 68 normas del catálogo tienen guard o audit.
...
Las 101 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 101 tools activas — 37 grupos
...
- 101 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
- 49 normas: 56 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
...
```
scripts/                    ← 124 archivos Python (101 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
