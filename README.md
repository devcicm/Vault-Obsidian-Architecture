...
[![Version](https://img.shields.io/badge/version-v40.20-blue)](./vault-obsidian-architecture.md)
...
| **Gobernanza** | 71 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 71 normas del catálogo tienen guard o audit.
...
- 49 normas: 59 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
