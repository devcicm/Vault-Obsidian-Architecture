...
[![Tools](https://img.shields.io/badge/tools-95_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-117_total-lightblue)](./scripts/)
...
Las 95 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 95 tools activas — 37 grupos
...
- 95 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
...
```
scripts/                    ← 117 archivos Python (95 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
