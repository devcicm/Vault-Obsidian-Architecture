...
[![Version](https://img.shields.io/badge/version-v40.7-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-97_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-120_total-lightblue)](./scripts/)
...
Las 97 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 97 tools activas — 37 grupos
...
- 97 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
...
```
scripts/                    ← 120 archivos Python (97 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
