...
[![Scripts](https://img.shields.io/badge/scripts-114_total-lightblue)](./scripts/)
...
| **Gobernanza** | 62 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 62 normas del catálogo tienen guard o audit.
...
Las 92 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 92 tools activas — 37 grupos
...
- 92 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
- 49 normas: 50 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
...
```
scripts/                    ← 114 archivos Python (92 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
