...
[![Version](https://img.shields.io/badge/version-v40.18-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-104_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-130_total-lightblue)](./scripts/)
...
| **Gobernanza** | 70 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 70 normas del catálogo tienen guard o audit.
...
Las 104 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 104 tools activas — 37 grupos
...
- 104 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
- 49 normas: 58 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
...
```
scripts/                    ← 130 archivos Python (104 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
