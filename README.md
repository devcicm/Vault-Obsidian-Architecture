...
[![Version](https://img.shields.io/badge/version-v40.2-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-96_active-green)](./scripts/)
[![Scripts](https://img.shields.io/badge/scripts-118_total-lightblue)](./scripts/)
...
```
scripts/                    ← 118 archivos Python (96 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
