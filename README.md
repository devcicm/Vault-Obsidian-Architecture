...
[![Version](https://img.shields.io/badge/version-v39.1-blue)](./vault-obsidian-architecture.md)
[![Tools](https://img.shields.io/badge/tools-89_active-green)](./scripts/)
...
| **Gobernanza** | 57 normas AP/PAT/SP/CN, 0 con enforcement manual | `vault_norms --audit` |
...
- **0 normas con enforcement `manual`**: las 57 normas del catálogo tienen guard o audit.
...
Las 89 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 89 tools activas — 36 grupos
...
- 89 tools con contratos exactos (parámetros, retorno, error codes, cuándo usar)
- 49 normas: 45 antipatrones (AP-01–AP-37), 6 patrones (PAT-1–PAT-6), 3 SP, 3 CN
...
```
scripts/                    ← 110 archivos Python (89 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
