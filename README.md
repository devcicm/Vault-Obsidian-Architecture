...
Las 91 tools bajo un único punto de entrada, con búsqueda, planificación de
...
## Las 91 tools activas — 37 grupos
...
```
scripts/                    ← 111 archivos Python (91 tools del catálogo + 8 archivadas en _archived/ + internas/meta)
