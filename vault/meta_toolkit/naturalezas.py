...
NATURALEZAS: Dict[str, Dict[str, Any]] = {
    ...
    "custodia": {
        ...
        "tools": [
            ...
            "vault_gobernanza", "vault_graph_fix", "vault_graph_inspect",
            "vault_graph_merge", "vault_history_compact", "vault_mermaid_check",
            "vault_propagate", "vault_quality_check", "vault_quality_dashboard",
            "vault_quarantine", "vault_qa_save", "vault_restore",
