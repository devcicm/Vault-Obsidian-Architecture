...
| 04 | [Antipatterns](./04-antipatterns.md) | Catálogo AP-01..AP-61 |
...
- **Vault version:** v40.22
- **Generated at:** 2026-08-14T23:31:55.000Z
...
| 04 | [Antipatterns](./04-antipatterns.md) | AP-01..AP-61 catalog |
| 05 | [Reference Matrix](./05-reference-matrix.md) | Pattern → Detect → Fix → Prevent |
