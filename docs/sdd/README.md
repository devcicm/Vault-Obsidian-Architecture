...
| 04 | [Antipatterns](./04-antipatterns.md) | Catálogo AP-01..AP-57 |
...
- **Vault version:** v40.12
- **Generated at:** 2026-08-13T03:19:39.000Z
...
| 04 | [Antipatterns](./04-antipatterns.md) | AP-01..AP-57 catalog |
| 05 | [Reference Matrix](./05-reference-matrix.md) | Pattern → Detect → Fix → Prevent |
