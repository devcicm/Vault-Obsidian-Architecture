...
| 04 | [Antipatterns](./04-antipatterns.md) | Catálogo AP-01..AP-60 |
...
- **Vault version:** v40.21
- **Generated at:** 2026-08-14T21:02:14.000Z
...
| 04 | [Antipatterns](./04-antipatterns.md) | AP-01..AP-60 catalog |
| 05 | [Reference Matrix](./05-reference-matrix.md) | Pattern → Detect → Fix → Prevent |
