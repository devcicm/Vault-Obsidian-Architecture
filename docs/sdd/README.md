...
| 04 | [Antipatterns](./04-antipatterns.md) | Catálogo AP-01..AP-58 |
...
- **Vault version:** v40.16
- **Generated at:** 2026-08-14T00:05:47.000Z
...
| 04 | [Antipatterns](./04-antipatterns.md) | AP-01..AP-58 catalog |
| 05 | [Reference Matrix](./05-reference-matrix.md) | Pattern → Detect → Fix → Prevent |
