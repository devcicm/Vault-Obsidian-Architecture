...
| 04 | [Antipatterns](./04-antipatterns.md) | Catálogo AP-01..AP-56 |
...
- **Vault version:** v40.11
- **Generated at:** 2026-08-13T02:21:42.000Z
...
| 04 | [Antipatterns](./04-antipatterns.md) | AP-01..AP-56 catalog |
| 05 | [Reference Matrix](./05-reference-matrix.md) | Pattern → Detect → Fix → Prevent |
