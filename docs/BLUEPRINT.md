...
| `vault_delete` | 23 — Change Log | escritura_a_gobernanza |
...
| `vault_doc_staleness` | 35 — Normas | gobernanza_del_estandar |
...
| `vault_history_compact` | 22 — Versionado | escritura_a_gobernanza |
...
| `vault_undo` | 22 — Versionado | escritura_a_gobernanza |
...
|---|---|---|---|---|
| `scripts/arch-baseline.json` | cruces entre contextos | 37 | — *sin objetivo* | 36 → 35 → 34 → 35 → 36 → 37 (encoge, Δ-20) |
| `scripts/arch-baseline.json` | cruces fuera de puerto | 8 | — *sin objetivo* | 12 → 12 → 8 → 8 → 8 → 8 (encoge, Δ-40) |
...
| `scripts/field-compat-baseline.json` | contrato de campos con los consumidores | 1339 | — *sin objetivo* | 1318 → 1334 → 1334 → 1334 → 1334 → 1339 (crece, Δ+225) |
...
*22 puertas de cierre. Generado por `scripts/vault_blueprint.py`.*
