...
**9 contextos**, **118 módulos** clasificados, **59 fronteras cruzadas** pendientes de publicar puerto.
...
- **Módulos (17):** `vault_arch`, `vault_blame_audit`, `vault_doc_counts`, `vault_doc_sync`, `vault_error_contract`, `vault_foreign_check`, `vault_gate`, `vault_manifest`, `vault_mcp`, `vault_mcp_catalog`, `vault_noop_audit`, `vault_smoke`, `vault_spec_catalog_check`, `vault_spec_generate_catalog`, `vault_spec_memory`, `vault_spec_validate`, `vault_test_runner`
