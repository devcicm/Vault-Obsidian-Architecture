...
**v40.17 · 104 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~130 scripts y 104 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 87 tools que escriben
