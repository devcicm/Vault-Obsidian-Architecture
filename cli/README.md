...
**v40.34 · 110 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~145 scripts y 110 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 93 tools que escriben
