...
**v39.0 · 101 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~106 scripts y 101 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 61 tools que escriben
