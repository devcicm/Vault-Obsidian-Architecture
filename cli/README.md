...
**v40.32 · 108 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~143 scripts y 108 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 91 tools que escriben
