...
**v40.34 · 117 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~153 scripts y 117 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 100 tools que escriben
