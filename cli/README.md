...
**v40.29 · 107 tools · 37 grupos · un único punto de entrada**
...
El repo tiene ~141 scripts y 107 tools activas. Cada una es un ejecutable independiente
...
python -m cli find "" --mode write     # las 90 tools que escriben
