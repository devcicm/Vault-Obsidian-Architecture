...
| `tests/` | Suite pytest (2882 tests). Toda norma con guard debe tener test. |
...
| Dato | Fuente |
|---|---|
| Normas AP/PAT/SP/CN y su enforcement | `scripts/vault_norms_catalog.py` (se entra por `vault_norms`, que lo reexporta) |
