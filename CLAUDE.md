...
| `scripts/*.py` | ~113 scripts, 92 tools activas en 37 grupos. Sin dependencias fuera de stdlib + PyYAML. |
| `scripts/README.md` | Referencia de tools por grupo, con ejemplos de CLI. |
| `tests/` | Suite pytest (1878 tests). Toda norma con guard debe tener test. |
