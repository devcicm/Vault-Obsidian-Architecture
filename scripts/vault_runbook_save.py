...
CATEGORIES = ["deploy", "debug", "setup", "rollback", "maintenance", "pipeline", "incident"]
...
def vault_runbook_save(
    ...
    if prerequisites:
        body_sections.append("## Prerequisitos\n\n" + "\n".join(f"- [ ] {p}" for p in prerequisites))
    ...
    body_sections.append("## Historial de Ejecuciones\n\n*Sin ejecuciones registradas.*")
...
""",
    ...
    parser.add_argument("--trigger", required=True, help="When this runbook should be triggered")
