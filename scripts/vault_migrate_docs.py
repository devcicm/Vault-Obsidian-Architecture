...
from vault_io import atomic_write_text, VAULT_ROOT
import uuid
...
CONTENT_SIGNALS = [
    (1, ["decision", "adr", "architecture decision", "we decided", "options considered"], "03_Decisions"),
    (2, ["report", "reporte", "audit report", "scan result", "finding", "assessment"], "10_Migrated/direct"),
    (3, ["readme", "overview", "introduction"], "01_Projects"),
    (4, ["api", "endpoint", "swagger", "openapi", "route", "rest", "graphql"], "07_Knowledge/apis"),
    (5, ["framework", "react", "vue", "express", "django", "nextjs", "laravel"], "07_Knowledge/frameworks"),
    (6, ["package", "dependency", "npm", "pip", "library", "libreria", "paquete"], "07_Knowledge/dependencies"),
    (7, ["deploy", "install", "setup", "rollback", "how to"], "08_Runbooks/setup"),
    (8, ["architecture", "pattern", "design", "schema", "diagram"], "05_Patterns/architecture"),
    (9, ["error", "bug", "exception", "fix", "incident"], "02_Observability/errors"),
    (10, ["config", "env", "variable", "setting", ".env", "yaml"], "07_Knowledge/configs"),
    (11, ["glossary", "term", "definition", "glosario"], "07_Knowledge/glossary"),
    (12, ["service", "server", "infra", "host", "ip", "port"], "09_Infrastructure/services"),
]
...
def classify_relevance(content: str, filename: str, project: str, keywords: List[str]) -> Tuple[str, str, str]:
...
""",
    ...
    parser.add_argument("--formats", nargs="*", default=[".md"], help="Formats to process")
    parser.add_argument("--dry_run", type=lambda x: x.lower() == "true", default=True, help="Dry run mode")
