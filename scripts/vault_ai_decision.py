...
DECISION_TYPES = ["architectural", "security", "data-model", "algorithm", "configuration", "process"]
...
def vault_ai_decision(
    ...
    if decision_type not in DECISION_TYPES:
        return {"ok": False, "error": f"decision_type '{decision_type}' not valid. Use: {DECISION_TYPES}"}
    if impact_level not in IMPACT_LEVELS:
        return {"ok": False, "error": f"impact_level '{impact_level}' not valid. Use: {IMPACT_LEVELS}"}
...
""",
    ...
    parser.add_argument("--decision_type", required=True,
                        help=f"Decision type: {DECISION_TYPES}")
    parser.add_argument("--description", required=True,
                        help="What decision was made")
    ...
    parser.add_argument("--risks",
                        help='JSON array of identified risks: ["risk description"]')
    parser.add_argument("--impact_level", default="medium",
                        help=f"Impact level (default: medium): {IMPACT_LEVELS}")
    parser.add_argument("--reversible", default=True, action=argparse.BooleanOptionalAction,
                        help="Whether the decision can be reversed (default: true)")
    parser.add_argument("--human_approved", action="store_true",
