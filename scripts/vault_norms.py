...
NORM_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Medido en v40.0 por el propio guard: **34 vínculos congelados en "
            "28 módulos** —eran 82 en 62 antes de empezar a migrar contextos al "
            "dominio; Durabilidad los dejó en 77, Índices en 69, Grafo en 51, "
            "Consulta en 45, Gobernanza en 38 y Ciclo de vida en 34, y bajan "
