...
NORM_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Medido en v40.0 por el propio guard: **51 vínculos congelados en "
            "43 módulos** —eran 82 en 62 antes de empezar a migrar contextos al "
            "dominio; Durabilidad los dejó en 77, Índices en 69 y Grafo en 51, y "
            "bajan cada vez que un contexto se migra—. La cifra es la que "
