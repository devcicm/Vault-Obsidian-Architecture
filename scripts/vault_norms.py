...
NORM_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Medido en v40.0 por el propio guard: **31 vínculos congelados en "
            "25 módulos** —eran 82 en 62 antes de empezar a migrar contextos al "
            "dominio; Durabilidad los dejó en 77, Índices en 69, Grafo en 51, "
            "Consulta en 45, Gobernanza en 38, Ciclo de vida en 34 y "
            "Meta-toolkit en 31, y bajan "
            "cada vez que un contexto se migra—. La "
            "cifra es la que "
