...
NORM_CATALOG: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Medido en v40.0 por el propio guard: **81 vínculos congelados en "
            "61 módulos** —eran 82 en 62 antes de migrar la primera tool al "
            "dominio—, y **69** módulos importan el valor `VAULT_ROOT` "
