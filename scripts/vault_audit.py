...
# superseded_by: vault_audit_catalog (v40.28) — AP-62. El criterio y su
# registro se fueron a una hoja del núcleo; aquí se reexportan para no
# derogar el contrato. Ver `vault_audit_catalog` para el porqué.
from vault_audit_catalog import (  # noqa: F401,E402
    DOCUMENTACION_DEL_ESTANDAR,
    MARCA_DEL_ESTANDAR,
    es_documentacion_del_estandar,
)
...
# superseded_by: vault_audit_catalog (v40.28) — AP-62. Ver arriba.
from vault_audit_catalog import (  # noqa: F401,E402
    FAMILIAS_DE_SALUD,
    PENALIZACIONES,
)
