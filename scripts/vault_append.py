...
def vault_append(
    path: str, content: str, section: Optional[str] = None, timestamped: bool = True
) -> dict:
    """
...
""",
    ...
    parser.add_argument(
        "--no-timestamp", action="store_true", help="Don't add timestamp"
    )
...
if __name__ == "__main__":
    sys.exit(wrap_main(main, "vault_append"))
